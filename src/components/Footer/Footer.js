            ...
            <div class="mx-auto w-full max-w-screen-xl p-4">
                <div class="md:flex md:justify-around">
                    <div className='flex flex-col md:w-1/2 sm:w-full'>
                        <ul class="flex flex-col gap-12 mt-16 pt-20">
                            <li class="flex items-center">
                                ...
                                <a href="javascript:void(0)" class="text-blue-600 text-xl ml-3">
                                    <small class="block">Tel</small>
                                    <strong>+91 9467863954</strong>
                                </a>
                            </li>
                            <li class="flex items-center">
                                <div class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                ...
                                <a href="javascript:void(0)" class="text-blue-600 text-xl ml-3">
                                    ...
                                    <strong>indiantutorexpert@gmail.com</strong>
                                </a>
                            </li>
                            <li class="flex items-center">
                                <div class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                    ...
                    <div className='flex flex-col md:w-1/2 sm:w-full'>
                        <section class="bg-white dark:bg-gray-900">
                            <div class="py-8 mt-10 px-4 mx-auto max-w-screen-md">
                                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-700 dark:text-white">Contact Us</h2>
                                <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Any query? Let us know.</p>
                                <form action="#" class="space-y-8">
                                    ...
                                    <div>
                                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Your Phone</label>
                                        <input type="tel" id="phone" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="+91" required></input>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="subject" class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Let us know how we can help you" required></input>
                                    </div>
                                    <div class="sm:col-span-2">
                                        <label for="message" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-400">Your message</label>
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" class="hover:underline">Indian Tutor Expert™</a>. All Rights Reserved.
                    </span>
